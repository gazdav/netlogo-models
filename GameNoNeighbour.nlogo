...
ifelse random-float 1 < 0.5 [
  ...
  ask row-player [
    ...
    set income-total ( 1 - coef-depreciation ) * income-total + income-current
;    ifelse row-strategy = 1 [
;    set income-total-cooperate ( 1 - coef-depreciation ) * ( income-total-cooperate + income-current ) ;
;    set income-total-defect ( 1 - coef-depreciation ) * income-total-defect
;    ]  [
;    set income-total-defect ( 1 - coef-depreciation ) * ( income-total-defect + income-current ) ;
;    set income-total-cooperate ( 1 - coef-depreciation ) * income-total-cooperate
;    ]
...
698
705
\n\n\n\nCoeficient of depreciation of the accumulated payoffs
12
0.0
1
...
1521
736
Counts of patches with strategy 1 and 0
time
number
0.0
10.0
